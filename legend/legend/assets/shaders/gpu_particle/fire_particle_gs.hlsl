#ifndef LEGEND_ASSETS_SHADERS_GPU_PARTICLE_FIRE_PARTICLE_GS_HLSL
#define LEGEND_ASSETS_SHADERS_GPU_PARTICLE_FIRE_PARTICLE_GS_HLSL
...
[maxvertexcount(MAX_VERTEX_COUNT)] void main(
  ...
  float4x4 world = float4x4(scale.x, 0, 0, 0, 0, scale.y, 0, 0, 0, 0, scale.z,
                            0, position.x, position.y, position.z, 1);
...
#endif  //! LEGEND_ASSETS_SHADERS_GPU_PARTICLE_FIRE_PARTICLE_GS_HLSL
